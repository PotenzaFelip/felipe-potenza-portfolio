# 📄 Currículo Interativo - Felipe Amaral Potenza

Este repositório contém o código-fonte do meu currículo profissional e portfólio online, hospedado através do **GitHub Pages**.

## 🚀 Tecnologias Utilizadas
* **HTML5** para estruturação semântica.
* **CSS3** para estilização moderna e responsiva.
* **FontAwesome** para iconografia técnica.
